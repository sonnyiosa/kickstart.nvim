...
require('lazy').setup({
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      --   mappings = {
      --     add = 'ys', -- Add surrounding (Normal/Visual) → ysiw), ys$"
      --     delete = 'ds', -- Delete surrounding → ds], dst, dsf
      --     replace = 'cs', -- Change/replace surrounding → cs'", csth1<CR>
      --     find = '', -- Not used in vim-surround style
      --     find_left = '', -- Not used in vim-surround style
      --     highlight = '', -- Not used in vim-surround style
      --
      --     suffix_last = '', -- Not needed
      --     suffix_next = '', -- Not needed
      --   },
      -- }
